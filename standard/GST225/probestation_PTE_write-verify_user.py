...
INI_settings = {
    ...
    'Trigger Source': 'CHANNEL2',
    'Trigger Level': {'Channel': 'CHANNEL2', 'Level': 0.5},
    'Channel 1 Scale': 0.1,  # 50 mV per division
    'Channel 1 Offset': 0.3,  # 100 mV offset
    'Channel 2 Scale': 1,  
    'Channel 2 Offset': 3,
    'Waveform Source': 'CHANNEL1',
    'Waveform Byte Order': 'LSBFirst',
...
INI = create_waveform(5e-6, 1e-6, 5e-6, 1.8, 1e-6, sample_rate)
...
for i in range(10):
    ...
    for T_SET in np.logspace(-8.7, -5, 30):
        tt = '{:.1e}'.format(T_SET)
        print(tt)
        for V_SET in np.linspace(0.2, 2, num=30):
            ...
            SET_settings['Channel 1 Offset'] = adjust_oscilloscope_scale(V_SET * 0.033, "voltage") * 3
