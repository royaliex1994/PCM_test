...
for V_RESET in np.linspace(0.2,2,30):
    ...
    File_PadName = "A4-1"
    Sub_folder = '5th_RESET_after cycle_50ns'
    ...
    RESET_settings['Channel 1 Offset'] = adjust_oscilloscope_scale(V_RESET * 0.033, "voltage") * 3
    RESET_settings['Channel 2 Scale'] = adjust_oscilloscope_scale(V_RESET * 0.4, "voltage")
    RESET_settings['Channel 2 Offset'] = adjust_oscilloscope_scale(V_RESET * 0.4, "voltage") * 3
