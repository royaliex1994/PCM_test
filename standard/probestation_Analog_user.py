...
RESET = create_waveform(2e-9, 2e-9, 2e-9, 0.5, 1e-6, sample_rate)
...
File_SampleName = "new_probe"
File_PadName = "100ohm_short_OPA_CURR"
Sub_folder = '0'
...
##
###RESET analog
##RESET = create_waveform(2e-9, 50e-9, 2e-9, 1.5, 1e-6, sample_rate)
##awg.waveforms["RESET"] = RESET
