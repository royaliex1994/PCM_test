...
RESET = create_waveform(1e-6, 20e-9, 1e-6, 2, 1e-6, sample_rate)
SET = create_waveform(1e-6, 2e-8, 1e-6, 2, 1e-6, sample_rate)
...
File_SampleName = "3-DIE-06"
File_PadName = "C3-4"
Sub_folder = '1st_OTS_cycle'
print(Sub_folder)
