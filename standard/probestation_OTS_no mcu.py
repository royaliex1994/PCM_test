...
TRI = create_waveform(1e-6, 1e-8, 1e-6, 2.8, 1e-6, sample_rate)
...
File_Root = "C:/Users/lisaadmin/Desktop/data/miao/new_probe/0717"
File_SampleName = "GeTe"
File_PadName = "D13-2"
Sub_folder = '2kOhm1us2.8x10'
print(Sub_folder)
...
for i in range(10):
    ...
    np.savez_compressed(generate_filename(f'OTS_{1*i+1}V', File_Path, '.npz'), times_v=times_v, voltages_v=voltages_v,times_i=times_i, voltages_i=voltages_i)
