...
RESET = create_waveform(2e-9, 50e-9, 2e-9, 2, 1e-6, sample_rate)
SET = create_waveform(2e-9, 2e-7, 1e-7, 1.2, 1e-6, sample_rate)
READ = create_waveform(1e-6, 3e-6, 1e-6, 0.1, 1e-6, sample_rate)
...
SET_settings = {
    ...
    'Channel 1 Probe': 1,
    'Channel 2 Probe': 10,
    'Timebase Scale': '2e-3',  # 5 microseconds per division
    'Timebase Position': '9e-3',  # 20 microseconds
    'Trigger Source': 'CHANNEL2',
    'Trigger Level': {'Channel': 'CHANNEL2', 'Level': 0.5},
    'Channel 1 Scale': 0.005,  # 50 mV per division
    'Channel 1 Offset': 0.005,  # 100 mV offset
    'Channel 2 Scale': 0.5,  
    'Channel 2 Offset': 1.5,
    'Waveform Source': 'CHANNEL1',
    'Waveform Byte Order': 'LSBFirst',
