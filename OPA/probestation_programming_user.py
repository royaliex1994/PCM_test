...
V_sweep = 10
points_sweep = 51  # 51 for time efficiency, 101 for Better resolution
V_read = 0.1
...
for V_RESET in np.linspace(0.1,0.9,30):
    ...
    File_PadName = "G1-3"
    Sub_folder = '2nd_RESET_after cycle_50ns'

    Record_ext = '_2_OPA.txt'
    ...
    # setup oscilloscope
    RESET_settings['Channel 1 Scale'] = adjust_oscilloscope_scale(V_RESET * 0.09, "voltage")
    RESET_settings['Channel 1 Offset'] = adjust_oscilloscope_scale(V_RESET * 0.09, "voltage") * 3
    RESET_settings['Channel 2 Scale'] = adjust_oscilloscope_scale(V_RESET * 1.5, "voltage")
    RESET_settings['Channel 2 Offset'] = adjust_oscilloscope_scale(V_RESET * 1.5, "voltage") * 3
    RESET_settings['Trigger Level']['Level'] = V_RESET * 4.5
