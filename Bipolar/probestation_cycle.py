...
RESET = create_waveform(20e-9, 100e-9, 20e-9, 0.75, 1e-6, sample_rate)
...
SET_settings = {
    ...
    'Timebase Position': '20e-4',  # 20 microseconds
    'Trigger Source': 'CHANNEL2',
    'Trigger Level': {'Channel': 'CHANNEL2', 'Level': 0.5},
    'Channel 1 Scale': 0.001,  # 50 mV per division
    'Channel 1 Offset': 0.002,  # 100 mV offset
    'Channel 2 Scale': 2,  
    'Channel 2 Offset': 0,
    'Waveform Source': 'CHANNEL1',
    'Waveform Byte Order': 'LSBFirst',
